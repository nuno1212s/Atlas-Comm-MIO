...
pub(crate) fn init_worker_group_handle<NI, CN, CNP>(worker_count: u32) -> (EpollWorkerGroupHandle<CN>, Vec<ChannelSyncRx<EpollWorkerMessage<CN>>>)
...
impl<CN> EpollWorkerGroupHandle<CN> {
    ...
    pub(super) fn assign_socket_to_worker(&self, conn_details: NewConnection<CN>) -> atlas_common::error::Result<()> {
